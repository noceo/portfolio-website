export default function FigureText(props) {
  return (
    <div className="container-fluid figureText">
      <div className="row">
        <figure className="col-10 offset-1 col-md-4 offset-md-2 col-lg-5 offset-lg-1">
        ...
        <p className="col-10 offset-1 col-md-4 offset-md-0 col-lg-4 offset-lg-1">{props.copy}</p>
      </div>
    </div>
  );
}
